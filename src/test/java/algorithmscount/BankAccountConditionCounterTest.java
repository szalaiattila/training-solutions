...
public class BankAccountConditionCounterTest {
    ...
    public void testCountWithBalanceGreaterThan() {
        ...
        assertEquals(3, new BankAccountConditionCounter().amountCounter(bankAccounts, 100));
        assertEquals(0, new BankAccountConditionCounter().amountCounter(bankAccounts, 400));
    }
}
